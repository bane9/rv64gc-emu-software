...
#define fb_dimensions_addr (fb_render_addr + 1 * sizeof(uint32_t))
#define term_dimensions_addr (fb_render_addr + 2 * sizeof(uint32_t))
#define fb_channels_addr (fb_render_addr + 3 * sizeof(uint32_t))
#define framebuffer_start_addr (fb_render_addr + 4 * sizeof(uint32_t))
