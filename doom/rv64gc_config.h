...
#define fb_dimensions_addr (fb_render_addr + sizeof(uint32_t))
#define term_dimensions_addr (fb_dimensions_addr + sizeof(uint32_t))
#define fb_channels_addr (term_dimensions_addr + sizeof(uint32_t))
#define framebuffer_start_addr (fb_channels_addr + sizeof(uint32_t))
